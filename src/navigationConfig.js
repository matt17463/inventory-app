...
export const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Product Color Manager', path: '/product-color-replacement', keywords: 'woocommerce product color add replace variations logo images blank mapping catalog correction' },
