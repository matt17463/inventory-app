...
The pull-sheet load path now reads directly from `jobs` and `job_items` and
contains no insert, update, synchronization, assignment, or pairing RPC call.
