...
The repair SQL is guarded, creates backups, releases reservations, cancels
rather than deletes job items, and creates an active manual-line uniqueness
index.
